...
from ccai.analysis.statistical.ir.binopmap import BinOpMap
from ccai.analysis.statistical.ir.boolopmap import BoolOpMap
from ccai.analysis.statistical.ir.compareopmap import CompareOpMap
